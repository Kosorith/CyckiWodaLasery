...
public interface IRankingService {
    ...
    /**
     * Dodaje punkty użytkownikowi o wskazanym identyfikatorze oraz zwiększa
     * ilość ukończonych wyzwań o 1.
     *
     ...
     *
     * @param userCredentials dane użytkownika, którego ranking ma zostać
     * pobrany
