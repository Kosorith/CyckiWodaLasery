...
public class UserProfileService implements IUserProfileService {
    ...
    @Override
    public boolean addUser(CreateUserRequest userData) {
        try {
            if (profilesDAO.findByLogin(userData.getLogin()) != null) {
                return false;
            }
            ...
            String digestedPassword = authenticationUtils.generateDigest(userData.getPassword());
